...
final class SiteMenuItemIndexPage extends IndexPage
{
    ...
    public function transferItem(
        ...
        // Перенос ветки между меню — структурная операция, доступна только
        // суперюзеру (Manager видит только стрелки сортировки, не саму кнопку).
        abort_unless($this->isSuperUser(), 403);
    ...
    private function transferButton(): ActionButton
    {
        ...
        return ActionButton::make('')
            ...
            ->showInLine()
            ->square()
            ->canSee(fn (): bool => $this->isSuperUser())
