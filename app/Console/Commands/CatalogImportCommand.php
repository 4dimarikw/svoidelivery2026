...
class CatalogImportCommand extends Command
{
    ...
    private function printReport(ImportReport $report): void
    {
        $rows = [
            ...
            ['Брендов создано', $report->brandsCreated],
            ...
            ['Вариаций создано', $report->variationsCreated],
            ['Вариаций обновлено', $report->variationsUpdated],
            ['Вариаций без изменений', $report->variationsUnchanged],
