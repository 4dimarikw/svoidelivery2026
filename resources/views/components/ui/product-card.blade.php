...
{{-- Карточка товара для каталога (главная, route `home`). Воспроизводит .card
     ...
     .qty из брендбука: при qty=0 видна кнопка «Купить» (задизейбленная, но
     без смены текста, если товара нет в наличии), при qty>0 — блок −/N/+ той
     же высоты; минус на количестве 1 убирает товар и возвращает «Купить».
     Количество сидируется с сервера
