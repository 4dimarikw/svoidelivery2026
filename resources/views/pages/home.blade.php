    ...
    <div class="mx-auto max-w-page px-6 py-10" x-data="{ filtersOpen: false }">
        <div class="mb-6 flex items-center justify-between">
            ...
            <div class="flex items-center space-x-4">
                <span class="text-body-m text-ink-500">{{ __('catalog.found', ['count' => $products->total()]) }}</span>
        ...
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-12">
            ...
            <div id="catalog-filters-panel" class="lg:order-2 lg:col-span-3 lg:block" :class="filtersOpen ? 'block' : 'hidden'">
                ...
                @else
                    ...
                    <div x-show="error" x-cloak class="py-8 text-center">
                        <x-ui.alert tone="err" class="inline-flex">
                            ...
                            <button type="button" x-on:click="loadMore()" class="ml-2 underline">{{ __('catalog.retry') }}</button>
                        </x-ui.alert>
                    </div>
                @endif
            </div>
