...
return [
    ...
    // количества после первого клика, см. product-card.blade.php. Если
    // товара нет в наличии — та же кнопка просто задизейблена
    // (cart-stepper.blade.php), текст не меняется.
    'buy' => 'Купить',
