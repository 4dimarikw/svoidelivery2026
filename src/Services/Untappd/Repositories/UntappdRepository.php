...
use Services\Untappd\Exceptions\UntappdException;
...
final class UntappdRepository implements UntappdInterface
{
    ...
    public function get(string $endpoint, ?array $options = []): ?UntappdApiResponse
    {
        ...
        try {
            ...
            $errorData = UntappdException::requestFailedData($e, $endpoint);

            Log::channel('database')->error($errorData['message'], [...$errorData['context'], 'dump' => $this->http->dump()]);
